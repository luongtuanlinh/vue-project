    ...
    <div>
        <div class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><router-link :to="{name: 'item.type.price.index'}">loại xe</router-link></li>
                <li class="active">Thêm giá</li>
            </ol>
        </div>
                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                ...
                                <div class="form-group" :class="{ 'has-error': form.errors.has('type') }">
                                    ...
                                    <select2 name="price_type" v-model="data.price_type" :options="price_types"/>
                                ...
                                <div class="form-group" :class="{ 'has-error': form.errors.has('type') }">
                                    ...
                                    <select2 name="time_type" v-model="data.time_type" :options="time_types"/>
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                ...
                this.form.post(route('api.item.type.price.store'))
                    .then(res=> {
                        this.loading = false;
                        if (res.success) {
