    ...
    <div>
        <div class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Đăng ký học</li>
            </ol>
        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group col-sm-3" :class="{ 'has-error': form.errors.has('phone') }">
                                        ...
                                        <input type="text" name="phone" class="form-control" v-model="student.phone" @input="inputChange">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group col-sm-3" :class="{ 'has-error': form.errors.has('course_id') }">
                                        <label class="control-label">Khóa học <span class="required">*</span></label>
                                        <select2 name="course_id" v-model="student.course_id" :options="courses" @change="form.errors.clear('course_id');getHocphi()"/>
                                    ...
                                    <div class="form-group col-sm-3" :class="{ 'has-error': form.errors.has('program_id') }">
                                        ...
                                        <select2 name="program_id" v-model="student.program_id" :options="programs" @change="form.errors.clear('program_id');getHocphi()"/>
                                        <span class="help-block" v-if="form.errors.has('program_id')">{{ form.errors.first('program_id') }}</span>
                                    </div>
<!--                                    <div class="form-group col-sm-3" :class="{ 'has-error': form.errors.has('group') }">-->
<!--                                        <label class="control-label">Nhóm học</label>-->
<!--                                        <input type="text" disabled class="form-control">-->
<!--                                        <span class="help-block" v-if="form.errors.has('group')">{{ form.errors.first('group') }}</span>-->
<!--                                    </div>-->
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group col-sm-3" :class="{ 'has-error': form.errors.has('fee') }">
                                        <label class="control-label">Học phí</label>
                                        <input type="text" name="fee" class="form-control" v-model="student.fee" disabled v-price>
...
<!--                                        <money name="sub_fee" class="form-control" v-model="student.sub_fee"></money>-->
...
<!--                                    </div>-->
                                    <div class="form-group col-sm-3" :class="{ 'has-error': form.errors.has('discount') }">
                                        ...
                                        <money name="discount" class="form-control" v-model="student.discount"></money>
                            ...
                            <div class="box-footer">
                                <el-form-item>
                                    <el-button type="success" @click="onSubmit(1)" :loading="loading">Lưu và thêm tiếp</el-button>
                                    <el-button type="success" @click="onSubmit(2)" :loading="loading">Lưu</el-button>
                                </el-form-item>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        watch: {
            'student.discount': function(newVal, oldVal) {
                this.fee()
            },
        },
        directives: {
        ...
        methods: {
            ...
            getHocphi() {
                let {course_id, program_id} = this.student;
                if (course_id && program_id) {
                    this.bodyLoading=true;
                    axios.get(route('api.fee.getFee', {course_id, program_id}))
                        .then(res => {
                            this.bodyLoading=false;
                            if(res.data.success){
                                this.student.fee = res.data.data.fee;
                            } else {
                                this.student.fee = null
                                this.$notify.error({
                                    title: 'Error',
