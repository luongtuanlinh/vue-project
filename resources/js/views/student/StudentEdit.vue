...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
              axios.get(route('api.source.detail', {id: this.id}))
                  .then(res=>{
            ...
            onSubmit() {
                ...
                this.form.post(route('api.source.update', {id: this.id}))
                    .then(res=> {
                        this.loading = false;
                        if (res.success) {
