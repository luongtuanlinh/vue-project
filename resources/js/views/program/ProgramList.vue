                        ...
                        <div class="box-body">
                            <div class="sc-table">
                                ...
                                <el-table
                                    ...
                                    <el-table-column prop="name" label="Chương trình đào tạo"></el-table-column>
                                    <el-table-column prop="time" label="Số giờ đào tạo"></el-table-column>
...
<script>
    export default {
        ...
        methods: {
            getData() {
                this.loading = true;
                axios.get(route('api.program.index', this.meta))
                    .then(res=>{
                        this.loading = false;
            ...
            gotoEdit(scope) {
                this.$router.push({ name: 'program.edit', params: { id: scope.row.id } });
            },
            confirmDelete(scope){
            ...
            delete(scope) {
                axios.post(route('api.program.delete'), {id: scope.row.id})
                    .then(res => {
                        if (res.data.success) {
