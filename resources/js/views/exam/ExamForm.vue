    ...
    <div>
        <div class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Thêm lớp thi</li>
            </ol>
        </div>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group col-sm-6" :class="{ 'has-error': form.errors.has('type') }">
                                        ...
                                        <select name="type" v-model="exam.type" class="form-control" @change="form.errors.clear('type')">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6" :class="{ 'has-error': form.errors.has('code') }">
                                        ...
                                        <input type="text" name="code" v-model="exam.code" class="form-control" @change="inputChange">
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                ...
                this.form.post(route('api.exam.store'))
                    .then(res=> {
                        this.loading = false;
                        if (res.success) {
