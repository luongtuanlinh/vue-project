                            ...
                            <div class="sc-table">
                                <div class="tool-bar el-row" style="padding-bottom: 20px;">
                                    <div class="actions el-col el-col-8">
                                        <router-link :to="{name: 'item.type.create'}">
                                ...
                                <el-table
                                    ...
                                    <el-table-column prop="name" label="Loại xe">
                                    </el-table-column>
                                    <el-table-column prop="type" label="Sở hữu">
                                    </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                this.loading = true;
                axios.get(route('api.item.type.index', this.meta))
                    .then(res=>{
                        this.loading = false;
            ...
            gotoEdit(scope) {
                this.$router.push({ name: 'item.type.edit', params: { id: scope.row.id } });
            },
            confirmDelete(scope){
