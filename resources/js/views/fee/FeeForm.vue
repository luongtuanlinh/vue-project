                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="form-group" :class="{ 'has-error': form.errors.has('class_id') }">
                                    ...
                                    <select2 name="type" v-model="item.class_id" :options="classes" @change="form.errors.clear('class_id')"/>
                                ...
                                <div class="form-group" :class="{ 'has-error': form.errors.has('program_id') }">
                                    ...
                                    <select2 name="program_id" v-model="item.program_id" :options="programs" @change="form.errors.clear('program_id')"/>
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                ...
                this.form.post(route('api.fee.store'))
                    .then(res=> {
                        this.loading = false;
                        if (res.success) {
