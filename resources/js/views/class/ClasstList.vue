                            ...
                            <div class="sc-table">
                                <div class="tool-bar el-row" style="padding-bottom: 20px;">
                                    <div class="actions el-col el-col-8">
                                        <router-link :to="{name: 'class.create'}">
                                ...
                                <el-table
                                    ...
                                    <el-table-column prop="name" label="Tên lớp">
                                    </el-table-column>
                                    <el-table-column prop="course" label="Khóa học">
                                    </el-table-column>
                                    <el-table-column prop="teacher" label="Giáo viên chủ nhiệm">
                                    </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                this.loading = true;
                axios.get(route('api.class.index', this.meta))
                    .then(res=>{
                        this.loading = false;
            ...
            gotoEdit(scope) {
                this.$router.push({ name: 'class.edit', params: { id: scope.row.id } });
            },
            confirmDelete(scope){
            ...
            delete(scope) {
                axios.post(route('api.class.delete'), {id: scope.row.id})
                    .then(res => {
                        if (res.data.success) {
