    ...
    <div>
        <div class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Nguồn tuyển sinh</li>
            </ol>
        </div>
                            ...
                            <div class="sc-table">
                                <div class="tool-bar el-row" style="padding-bottom: 20px;">
                                    <div class="actions el-col el-col-8">
                                        <router-link :to="{name: 'source.create'}">
                                ...
                                <el-table
                                    ...
                                    <el-table-column prop="name" label="Nguồn tuyển sinh">
                                    </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                this.loading = true;
                axios.get(route('api.source.index', this.meta))
                    .then(res=>{
                        this.loading = false;
            ...
            gotoEdit(scope) {
                this.$router.push({ name: 'source.edit', params: { id: scope.row.id } });
            },
            confirmDelete(scope){
            ...
            delete(scope) {
                axios.post(route('api.source.delete'), {id: scope.row.id})
                    .then(res => {
                        if (res.data.success) {
